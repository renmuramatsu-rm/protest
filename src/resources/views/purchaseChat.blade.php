...
@section('css')
<link rel="stylesheet" href="{{ asset('css/purchaseChat.css') }}">
@endsection
    ...
    <article class="content">
        <div class="article-title">
            <div class="title-item">
                <div class="title-img">
                    @if (isset($seller->profile->image))
                    <img class="mypage-profile__img" src="{{ asset('storage/' . ($seller->profile->image)) }}">
                    @else
                ...
                <div class="title-text">
                    <p>
                        「{{ $item->sells->name }}」さんとの取引画面
                    </p>
                </div>
            </div>
            <div class="title-btn">
                <form class="form-complete" action="{{ route('complete', $item->id) }}" method="POST">
                    @csrf
                    <a class="complete-text" href="#{{$item->user_id}}">取引を完了する</a>
                </form>
            </div>
        </div>
        ...
        <div class="chat-display">
            ...
            @elseif($message->user_id == $item->user_id)
